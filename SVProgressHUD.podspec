Pod::Spec.new do |s|
  s.name     = 'SVProgressHUD13'
  s.version  = '2.2.8'
  s.ios.deployment_target = '8.3'
  s.tvos.deployment_target = '9.0'
  s.license  =  { :type => 'MIT', :file => 'LICENSE' }
  s.summary  = 'A clean and lightweight progress HUD for your iOS and tvOS app.'
  s.homepage = 'https://github.com/touchberry/SVProgressHUD'
  s.authors   = { 'Sam Vermette' => 'hello@samvermette.com', 'Tobias Tiemerding' => 'chen@touchberry.net' }
  s.source   = { :git => 'https://github.com/touchberry/SVProgressHUD.git', :tag => s.version.to_s }
